...
class GuardrailsChatCompletion(ChatCompletion):
    ...
    messages: Optional[List[dict]] = Field(default=None, description="Chat UI compatible messages array.")
...
class OpenAIChatCompletionRequest(BaseModel):
    ...
    @classmethod
    def coerce_model_to_string(cls, v: Any) -> Optional[str]:
        if isinstance(v, dict):
            return None  # Chat UI passes config ID as model object; ignore it, use config.yml's model
        return v
